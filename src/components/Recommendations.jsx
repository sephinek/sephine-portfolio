...
export default function Recommendations() {
  return (
    <section className="py-24 px-16 flex flex-col gap-16 cursor-default bg-lightergrey text-mediumgrey font-medium">
            ...
            <div className="flex flex-col gap-4 text-lg leading-relaxed">
              ...
              <div className="flex flex-col items-center mx-auto">
                <div className="flex items-baseline gap-3">
                  <span className="text-xl font-medium tracking-normal text-darkgrey">
                    Misoon Jang
                  </span>
                </div>
            ...
            <div className="flex flex-col gap-4 text-lg leading-relaxed">
              <div className="flex flex-col gap-2">
                ...
                <p className="px-8 tracking-normal">
                  ...
                  purpose. Her{' '}
                  <span className="font-bold text-darkgrey">leadership</span>{' '}
            ...
            <div className="flex flex-col gap-4 text-lg leading-relaxed">
              <div className="flex flex-col gap-2">
                ...
                <p className="px-8 tracking-normal">
                  ...
                  support her journey and look forward to her continued success.
                </p>
                <VscQuote className="text-secondary rotate-180 self-end" />
              </div>
              <div className="flex flex-col items-center mx-auto">
