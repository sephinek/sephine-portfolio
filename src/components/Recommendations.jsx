  ...
  return (
    <section className="py-24 px-16 flex flex-col gap-16 cursor-default bg-lightergrey text-mediumgrey font-medium">
      <div className="max-w-6xl w-full mx-auto flex flex-col gap-16">
        ...
        <ul className="max-w-[80%] mx-auto flex flex-col gap-28">
          <li className="flex flex-col gap-8">
            <div className="flex flex-col gap-4 text-lg leading-relaxed">
              <div className="flex flex-col gap-2">
                <VscQuote className="text-mediumgrey self" />
                <p>
                ...
                <VscQuote className="text-mediumgrey rotate-180 self-end" />
              </div>
          ...
          <li className="flex flex-col gap-8">
            <div className="flex flex-col gap-4 text-lg leading-relaxed">
              <div className="flex flex-col gap-2">
                <VscQuote className="text-mediumgrey" />
                <p>
